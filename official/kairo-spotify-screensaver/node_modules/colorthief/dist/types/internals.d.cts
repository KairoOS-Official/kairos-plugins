import { Q as Quantizer, P as PixelLoader, B as BrowserSource, G as Gamut, h as PixelData, N as NodeSource, C as Color, S as SwatchMap, O as OKLCH, i as PixelBuffer, F as FilterOptions, R as Region, E as ExtractionOptions } from './types-9iguqy6k.cjs';
...
declare class NodePixelLoader implements PixelLoader<NodeSource> {
    ...
    load(source: NodeSource, _signal?: AbortSignal, _gamut?: Gamut | 'auto'): Promise<PixelData>;
}
...
declare function p3ToSrgb(r: number, g: number, b: number): [number, number, number];
/** Convert an sRGB pixel (0–255) to Display-P3 (0–255). */
declare function srgbToP3(r: number, g: number, b: number): [number, number, number];
/** True if a Display-P3 pixel (0–255) falls outside the sRGB gamut. */
declare function isOutOfSrgbGamut(r: number, g: number, b: number): boolean;
/** WCAG relative luminance from RGB (0–255) in the given gamut. */
declare function relativeLuminance(r: number, g: number, b: number, gamut?: Gamut): number;
 ...
 */
declare function resolveOutputGamut(pixelArray: Array<[number, number, number]>, nativeGamut: Gamut, requested: Gamut | 'auto'): Gamut;
...
export { BrowserPixelLoader, Gamut, MmcqQuantizer, type NodeImageDecoder, NodePixelLoader, PixelBuffer, PixelData, PixelLoader, type PixelRect, Quantizer, WasmQuantizer, classifySwatches, computeFallbackColor, createNodeLoader, createPixelArray, cropPixelData, extractInWorker, extractPalette, isOutOfSrgbGamut, isWorkerSupported, linearToSrgb, oklchToRgb, p3ToSrgb, paletteOklchScaledToRgb, pixelsRgbToOklchScaled, regionToPixelRect, relativeLuminance, resolveOutputGamut, rgbToOklch, srgbToLinear, srgbToP3, terminateWorker, validateOptions, validateRegion };
