import { P as PixelLoader, I as ImageSource, Q as Quantizer, E as ExtractionOptions, C as Color, a as ProgressiveResult, S as SwatchMap, F as FilterOptions, b as ColorSpace, R as Region, G as Gamut, B as BrowserSource } from './types-9iguqy6k.cjs';
export { c as ContrastInfo, d as CssColorFormat, H as HSL, N as NodeSource, O as OKLCH, e as RGB, f as Swatch, g as SwatchRole } from './types-9iguqy6k.cjs';
 ...
 */
declare function createColor(r: number, g: number, b: number, population: number, proportion?: number, gamut?: Gamut): Color;

export { BrowserSource, Color, ColorSpace, ExtractionOptions, FilterOptions, Gamut, ImageSource, type ObservableSource, type ObserveController, type ObserveOptions, ProgressiveResult, Region, SwatchMap, type SyncExtractionOptions, configure, createColor, getColor, getColorSync, getPalette, getPaletteProgressive, getPaletteSync, getSwatches, getSwatchesSync, observe };
